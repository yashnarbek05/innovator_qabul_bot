...
from bot.service import PHOTO, photo, start, language, LANGUAGE, fullname, FULLNAME, \
    ...
    capture_rejection_reason, search, receive_number, NUMBER, AGE, age, WORK, work, GMAIL, gmail, HUDUD, hudud, DIRECTION, direction, OFFERS, offers, REGENERATE, regenerate
